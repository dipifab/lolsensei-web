  ...
  return (
    <>
      ...
      <main class="pt-20">
          ...
          <div class="max-w-7xl mx-auto px-8 relative z-10">
            <div class="max-w-3xl">
              <span class="inline-block py-1 px-3 rounded-sm bg-tertiary-container/10 text-tertiary text-xs font-bold tracking-[0.2em] uppercase mb-6">
                Tactical Precision Engine
              </span>
              <h1 class="text-6xl md:text-8xl font-headline font-extrabold tracking-tighter leading-[0.9] text-on-surface mb-8">
                MASTER EVERY <span class="text-primary-container">PHASE.</span>
              </h1>
              <p class="text-xl text-on-surface-variant/80 max-w-xl leading-relaxed">
                LoL Sensei isn't just an overlay. It's a high-precision instrument that
                decodes complex match data into actionable tactical advantages.
              </p>
            </div>
          </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div class="order-1 lg:order-2">
                <div class="flex items-center gap-3 mb-4">
                  ...
                  <span class="text-primary-container text-xs font-bold tracking-widest uppercase">Phase 01</span>
                </div>
                <h2 class="text-4xl md:text-5xl font-headline font-extrabold tracking-tight mb-6">Champion Select AI</h2>
                <p class="text-on-surface-variant leading-relaxed text-lg mb-8">
                  Our AI analyzes your entire champion pool against real-time enemy locks.
                  It doesn't just suggest counters; it evaluates team composition synergy,
                  scaling curves, and damage distribution to secure your win before the game
                  even begins.
                </p>
                <ul class="space-y-4">
                  <li class="flex items-start gap-3">
                    <span class="material-symbols-outlined text-tertiary text-sm mt-1">check_circle</span>
                    <span class="text-on-surface/80">Deep synergy mapping with ally picks.</span>
                  </li>
                  <li class="flex items-start gap-3">
                    <span class="material-symbols-outlined text-tertiary text-sm mt-1">check_circle</span>
                    <span class="text-on-surface/80">Automated ban suggestions based on meta-trends.</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                <div class="flex items-center gap-3 mb-4">
                  ...
                  <span class="text-primary-container text-xs font-bold tracking-widest uppercase">Phase 02</span>
                </div>
                <h2 class="text-4xl md:text-5xl font-headline font-extrabold tracking-tight mb-6">Strategic Briefing</h2>
                <p class="text-on-surface-variant leading-relaxed text-lg mb-8">
                  The loading screen is your tactical window. Sensei provides a comprehensive
                  breakdown of win conditions, key timing windows, and matchup dynamics.
                  Know exactly when you're strongest and where the enemy is most vulnerable.
                </p>
              ...
              <div class="relative">
                ...
                <div class="relative glass-panel border border-outline-variant/20 rounded-2xl p-4 md:p-8">
                  <div class="flex items-center justify-between mb-8 border-b border-outline-variant/10 pb-4">
                    <span class="text-sm font-bold tracking-tighter italic">TACTICAL_HUD_V2.0</span>
        ...
        {/* Feature 3: Adaptive Build Advisor */}
          ...
          <div class="max-w-7xl mx-auto px-8">
            <div class="text-center max-w-3xl mx-auto mb-20">
              <div class="flex justify-center items-center gap-3 mb-4">
                ...
                <span class="text-primary-container text-xs font-bold tracking-widest uppercase">Phase 03</span>
              </div>
              <h2 class="text-4xl md:text-6xl font-headline font-extrabold tracking-tight mb-6">Adaptive Build Advisor</h2>
              <p class="text-on-surface-variant text-lg">
                Static guides are for amateurs. LoL Sensei recalculates your optimal build
                every time you press TAB, reacting to enemy snowballing, resistance stacking,
                and objective priority.
              </p>
            </div>
            <div class="grid md:grid-cols-3 gap-8">
              <div class="glass-panel p-10 rounded-2xl border border-outline-variant/10 hover:border-primary/30 transition-all group">
                ...
                <h3 class="text-xl font-headline font-bold mb-4">Real-Time Adaptation</h3>
                <p class="text-on-surface-variant/80 text-sm leading-relaxed">
                  Instantly shifts recommendations if the enemy Zed gets 3 early kills.
                  Gain the exact defense you need, exactly when you need it.
                </p>
              </div>
              <div class="glass-panel p-10 rounded-2xl border border-outline-variant/10 hover:border-primary/30 transition-all group">
                <div class="w-12 h-12 rounded-xl bg-surface-container-highest flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                ...
                <h3 class="text-xl font-headline font-bold mb-4">Efficiency Metrics</h3>
                <p class="text-on-surface-variant/80 text-sm leading-relaxed">
                  Visualizes gold efficiency and completion breakpoints for every component
                  in your inventory. Never waste a single gold piece.
                </p>
              </div>
              <div class="glass-panel p-10 rounded-2xl border border-outline-variant/10 hover:border-primary/30 transition-all group">
                <div class="w-12 h-12 rounded-xl bg-surface-container-highest flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                ...
                <h3 class="text-xl font-headline font-bold mb-4">Smart Buy Priority</h3>
                <p class="text-on-surface-variant/80 text-sm leading-relaxed">
                  Always know which component to buy next. Sensei highlights the best
                  next purchase based on your current gold and the enemy team composition.
                </p>
              </div>
            </div>
          </div>
        ...
        <section class="py-32 relative overflow-hidden">
          ...
          <div class="max-w-4xl mx-auto px-8 text-center relative z-10">
            <h2 class="text-5xl md:text-7xl font-headline font-extrabold tracking-tighter mb-10 leading-tight">
              READY TO ACHIEVE <br />
              <span class="text-primary-container">TRUE MASTERY?</span>
            </h2>
            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a
                href={DOWNLOAD_INFO.url}
                class="gold-gradient text-on-primary-fixed px-10 py-5 rounded-lg font-headline font-extrabold text-lg uppercase transition-all hover:shadow-[0_0_30px_rgba(240,191,92,0.3)] hover:-translate-y-1"
              >
