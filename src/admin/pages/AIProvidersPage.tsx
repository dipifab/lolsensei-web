...
function ProviderCard(props: ProviderCardProps) {
  ...
  const modelColumns: ColumnDef<AIModelResponse>[] = [
    ...
    },
    {
      key: 'status',
      header: 'Stato',
      render: (row) => <AdminBadge variant={row.is_active ? 'active' : 'inactive'} dot />,
    },
    {
      key: 'actions',
      header: '',
    ...
    <AdminCard
      ...
      titleRight={
        <div class="flex items-center gap-3">
          <AdminBadge variant={props.provider.is_active ? 'active' : 'inactive'} dot />
          <AdminToggle
      ...
      <div class="space-y-5">
        ...
        <div class="flex items-center gap-3 flex-wrap">
          ...
          <Show
            when={showKeyInput()}
            fallback={
              <AdminButton variant="ghost" onClick={() => setShowKeyInput(true)}>
                Cambia chiave
              </AdminButton>
            }
          >
